...
For deterministic mock runs where assertions can pass, see [examples/voice-ivr/](/arena/how-to/voice/voice-ivr/), which uses a text-mode mock provider that does execute scripted tool calls.
