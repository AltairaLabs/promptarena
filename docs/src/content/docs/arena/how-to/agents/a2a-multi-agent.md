---
title: Test Multi-Agent A2A Delegation
...
See [Test A2A Agents](/arena/how-to/agents/test-a2a-agents/) for the full reference covering authentication, headers, and skill filtering.
