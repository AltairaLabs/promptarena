...
const ADAPTERS = [
  ...
  buildAdapterConfig(
    ...
    {
      // Extra files specific to vertex.
      "how-to/tools.md": {
        target: "how-to/deploy/vertex/tools.md",
        order: 45,
      },
      "how-to/observability.md": {
        target: "how-to/deploy/vertex/observability.md",
        order: 45,
      },
      "reference/environment-variables.md": {
        target: "reference/deploy/vertex/env-vars.md",
        order: 45,
      },
      "reference/runtime-protocols.md": {
        target: "reference/deploy/vertex/runtime-protocols.md",
        order: 45,
      },
    },
    // baseOrder 45 sorts vertex between omnia (40) and agentcore (50).
    45,
  ),
];
