...
For a complete working example, see the [`examples/client-tools/`](https://github.com/AltairaLabs/promptarena/v2/tree/main/examples/client-tools) directory in the PromptKit repository.
